...
export class ErosaoController {
  ...
  getErosaoAsPercentual(): IPercentualData[] {
    const items: IPercentualData[] = this.service.getPercentualErosaoAreaData();
  ...
  getErosaoRiscoCultusAsPercentual(): IPercentualData[] {
    const items: IPercentualData[] = this.service.getPercentualErosaoRiscoCulturasData();
  ...
  getErosaoRiscoPastagensAsPercentual(): IPercentualData[] {
    const items: IPercentualData[] = this.service.getPercentualErosaoRiscoPastagensData();
